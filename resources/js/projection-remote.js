    ...
    Alpine.data('projectionRemote', (config = {}) => ({
        ...
        onKey(event) {
            ...
            const keys = {
                ...
                PageDown: () => this.moved('next', musicStartAt(this.slides, this.entries, this.index, 'next')),
                ...
                PageUp: () => this.moved('previous', musicStartAt(this.slides, this.entries, this.index, 'previous')),
