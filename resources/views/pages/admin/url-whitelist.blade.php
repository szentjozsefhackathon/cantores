        ...
        <div>
            ...
            <div class="mb-6 grid gap-4 md:grid-cols-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <flux:button wire:click="bulkDelete" :disabled="empty($selectedRules)" variant="danger" size="sm">
                        Delete
                    </flux:button>
                </div>
            </div>
            ...
            <flux:table>
                <flux:table.columns>
                    ...
                    <flux:table.column>Path Prefix</flux:table.column>
                    <flux:table.column>Scheme</flux:table.column>
                    <flux:table.column>Status</flux:table.column>
                    <flux:table.column>Description</flux:table.column>
                    <flux:table.column>Matching URLs</flux:table.column>
