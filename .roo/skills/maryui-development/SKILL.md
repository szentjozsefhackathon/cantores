...
description: >-
  Develops UIs with Mary UI. This is used when the user specifically asks for a Mary UI component. Mary UI contains components for Livewire,  powered by daisyUI and Tailwind.
---
